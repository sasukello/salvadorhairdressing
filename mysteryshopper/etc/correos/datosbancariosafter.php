    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          ...
          <tr>
            <td class="free-text">
              El participante ha completado con éxito su información bancaria. Inicia sesión con tu cuenta corporativa en el portal web, para <b>programarle</b> una visita a un salón:
            </td>
          </tr>
          <tr>
            <td class="button">
