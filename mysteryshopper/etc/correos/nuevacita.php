    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td class="header-lg">
              ¡Tienes una visita como Mystery Shopper!
            </td>
          </tr>
          <tr>
            <td class="free-text">
              ¡Nuestro equipo <b>Mystery Shopper</b> de <b><i>Salvador Hairdressing</i></b> te ha asignado una nueva visita! Entra en tu cuenta y consulta todos los detalles de la misma.
            </td>
          </tr>
        </table>
      </center>
