...
/**Modal**/
	function revistacambio($numero){
		if ($numero=="") {
			...
			if ($numero=="37") {
				document.getElementById("espaciorevista").innerHTML = "<iframe style='width:100%; height:600px;' src='//e.issuu.com/embed.html#3474702/56697535' frameborder='0' allowfullscreen></iframe>";
				document.getElementById("titulorevista").innerHTML = "Edición 37";
			}else if ($numero=="36") {
