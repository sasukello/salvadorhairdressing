...
function opcionespermitidas($user, $password){
    ...
    require_once "libcon.php";
        ...
        $con = Conectarfb();
        $sql = "SELECT CODIGO, NOMBRECOMPLETO, COALESCE(IDIOMAINTRANET, 'esp') as idioma FROM usuarios WHERE CODIGO = '".$nombre."' and clavehash = hash('".$password."')";
        ...
        if (!empty($datosusuario)){
           ...
           echo "Error Usuario o clave no existe - ";
...
function listapersonal(){
    ...
    require_once "libcon.php";
        ...
        $con = Conectarfb();
        $sql = "select * FROM  PERSONAL WHERE FECHAINGRESO >= '2017-06-01'";
