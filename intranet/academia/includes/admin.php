...
function guardarCT($curso, $tipoct, $descripcion, $imagen, $user, $materiales, $cant_notas, $tipo_eval, $porc_nota1, $porc_nota3, $porc_nota2, $porc_nota4, $porc_nota5)
{ // Guarda los nuevos cursos y talleres
  $dbh = dbconnlocal2();
  mysqli_set_charset($dbh, 'utf8');
  ...
  if ($foto[0] == 1) {
    ...
    if (mysqli_query($dbh, $sql)) {
      header('Location: ../academia/?resct=success&tipo=' . $tipoct . '');
      die();
    } else {
      var_dump(mysqli_error($dbh));
      die();
      header('Location: ../academia/?resct=fail&tipo=' . $tipoct . '');
      die();
    }
  } else {
    header('Location: ../academia/?resct=error&tipo=' . $tipoct . '');
    die();
  }
...
function selectCursos($idcurso)
{ // Muestra el select con las opciones de los cursos 0: nuevo else modificar
  $dbh = dbconnlocal2();
  mysqli_set_charset($dbh, 'utf8');
...
function selectLocation($idlocation)
{ // Muestra el select con las ubicaciones Salvador Academy
  $dbh = dbconnlocal2();
  mysqli_set_charset($dbh, 'utf8');
...
function selectTeacher($idprofesor)
{ // Muestra el select con las opciones de los profesores
  $dbh = dbconnlocal2();
  mysqli_set_charset($dbh, 'utf8');
...
function formHorarios($user)
{ // Formulario para agregar horarios en admin
  $selectCT = selectCursos(0);
  $selectUB = selectLocation(0);
  $selectPR = selectTeacher(0);
  $result = '<div class="p-20">
				<form action="/intranet/academia/api.php" method="POST" enctype="multipart/form-data">
					<div class="row">
						<div class="col-sm-6">
...
function guardarHorario($fechainicio, $fechafinal, $turno, $horario, $cursoid, $ubicacionid, $idprofesor, $precio1, $precio2, $capacidad, $usuario)
{ // Guarda los horarios en la base de datos
  ...
  $result = "";
  if (mysqli_query($dbh, $sql)) {
    header('Location: ../academia/?horario=success');
    die();
    $result = 1;
  } else {
    header('Location: ../academia/?horario=fail');
    die();
    $result = 0;
  }
  return $result;
...
function verInfoCT($idCT)
{ // Muestra la información del curso seleccionado en tabla cursos
  $dbh = dbconnlocal2();
  mysqli_set_charset($dbh, 'utf8');
...
{ #Consulta el nombre y apellido segun id del usuario
  $dbh = dbconnlocal2();
  mysqli_set_charset($dbh, 'utf8');
...
function modificarInfoCT($idCT, $user)
...
function updateCT($id, $tipo, $estado, $nombre, $descripcion, $usuario, $materiales, $cant_notas, $tipo_eval, $porc_nota1, $porc_nota3, $porc_nota2, $porc_nota4, $porc_nota5)
{
  ...
  $result = "";
  if (mysqli_query($dbh, $sql)) {
    header('Location: ../academia/?ctupd=success&tipo=' . $tipo . '');
    die();
    $result = 1;
  } else {
    header('Location: ../academia/?ctupd=fail&tipo=' . $tipo . '');
    die();
    $result = 0;
  }
  return $result;
...
function updateImagen($iduser, $idCT, $imagen)
{
  ...
  if ($foto[0] == 1) {
    ...
    $result = "";
    if (mysqli_query($dbh, $sql)) {
      header('Location: ../academia/?ctupd=success&msg=' . $foto[0] . '');
      die();
      $result = 1;
    } else {
      header('Location: ../academia/?ctupd=fail&msg=' . $foto[0] . '');
      die();
      $result = 0;
    }
  } else {
...
function updateGuia($iduser, $idCT, $guia)
{
  ...
  if ($guia[0] == 1) {
    ...
    $result = "";
    if (mysqli_query($dbh, $sql)) {
      header('Location: ../academia/?ctupd=success&msg=' . $guia[0] . '');
      die();
      $result = 1;
    } else {
      header('Location: ../academia/?ctupd=fail&msg=' . $guia[0] . '');
      die();
      $result = 0;
    }
  } else {
...
function verInfoHorarios($idhorario)
{ // Muestra la información de los horarios en el modal en el administrador
...
function modificarInfoHorarios($idhorario, $usuario)
{ #Muestra el formulario para modificar los horarios
  $dbh = dbconnlocal2();
  mysqli_set_charset($dbh, 'utf8');
...
function modificarHorarios($ubicacion, $profesor, $capacidad, $inicio, $final, $precio1, $precio2, $turno, $horario, $usuario, $idhr)
{ #Modifica los horarios en la BD
  $dbh = dbconnlocal2();
  mysqli_set_charset($dbh, 'utf8');
  ...
  $result = "";
  if (mysqli_query($dbh, $sql)) {
    header('Location: ../academia/?hrupd=success');
    die();
    $result = 1;
  } else {
    header('Location: ../academia/?hrupd=fail');
    die();
    $result = 0;
  }
  return $result;
...
function verInscritosHorario($idhorario)
{ #Muestra los estudiantes inscritos por horario
  $dbh = dbconnlocal2();
  mysqli_set_charset($dbh, 'utf8');
...
function consultarNombreCTH($idhorario)
{ #Consulta el nombre del curso segun id horario
  $dbh = dbconnlocal2();
  mysqli_set_charset($dbh, 'utf8');
...
function verEstudiantesMorosos()
{ // Consulta los cursos activos asignados al docente
  $dbh = dbconnlocal2();
  mysqli_set_charset($dbh, 'utf8');
...
function verInfoEstudiantes($idestudiante)
{ #Muestra la info de estudiantes en el modal
  $dbh = dbconnlocal2();
  mysqli_set_charset($dbh, 'utf8');
...
function modificarDatosEstudiante($idestudiante, $usuario)
{ #Muestra el formulario para modificar datos de estudiantes
  $dbh = dbconnlocal2();
  mysqli_set_charset($dbh, 'utf8');
  ...
  if ($match > 0) {
    ...
    $formulario = '<div class="p-20">
					<form action="/intranet/academiaapi.php" method="PO/ST" name="reservation_form" class="reservation-form">
		            <div class="row">
		              <div class="col-sm-6">
		                <div class="form-group mb-10">
		                  <div class="styled-select">
...
function modificarEstudiante($tipo, $doc, $nombre, $apellido, $civil, $profesion, $ffnn, $paises, $sexo, $telf1, $telf2, $telf3, $correo, $direccion, $user, $idest, $estado)
{ #Modifica los datos de estudiante en la BD
  $dbh = dbconnlocal2();
  mysqli_set_charset($dbh, 'utf8');
  ...
  $result = "";
  if (mysqli_query($dbh, $sql)) {
    header('Location: ../academia/?updest=success');
    die();
    $result = 1;
  } else {
    header('Location: ../academia/?updest=fail');
    die();
    $result = 0;
  }
  return $result;
...
{
  $result = '<div class="p-20"><form action="/intranet/aca/demiaapi.php" class="reservation-form" method="POST">
            <div class="row">
...
{ #Muestra la tabla de profesores en el administrador
  $dbh = dbconnlocal2();
  mysqli_set_charset($dbh, 'utf8');
...
function verInfoProf($idprof)
{ # Muestra la informacion del profesor en el modal
  $dbh = dbconnlocal2();
  mysqli_set_charset($dbh, 'utf8');
...
function modInfoProf($idprof, $usuario)
{ #Muestra el formulario para modificar datos de estudiantes
  $dbh = dbconnlocal2();
  mysqli_set_charset($dbh, 'utf8');
  ...
  if ($match > 0) {
    ...
    $formulario = '<div class="p-20">
					<form action="/intranet/aca/demiaapi.php" method="POST" class="reservation-form">
		            <div class="row">
		              <div class="col-sm-6">
		                <div class="form-group mb-10">
		                  <label class="mb-0">Documento de Identificación</label>
...
function modificarProfesor($doc, $estado, $nombre, $apellido, $correo, $telef1, $telef2, $usuario, $idprof)
{ #Modifica los datos de profesores en la BD
  $dbh = dbconnlocal2();
  mysqli_set_charset($dbh, 'utf8');
  ...
  $result = "";
  if (mysqli_query($dbh, $sql)) {
    header('Location: ../academia/?updprof=success');
    die();
    $result = 1;
  } else {
    header('Location: ../academia/?updprof=fail');
    die();
    $result = 0;
  }
  return $result;
...
function addProfesor($doc, $nombre, $apellido, $correo, $pass1, $pass2, $telef1, $telef2)
{
  ...
  if ($pass1 == $pass2) {
    ...
    $result = "";
    if (mysqli_query($dbh, $sql)) {
      header('Location: ../academia/?addprof=success');
      die();
      $result = 1;
    } else {
      header('Location: ../academia/?addprof=fail');
      die();
      $result = 0;
    }
  } else {
    header('Location: ../academia/?addprof=verify');
    die();
  }
...
function selectHorarios($idhorario)
{ // Muestra el select con las opciones de los cursos 0: nuevo else modificar
  $dbh = dbconnlocal2();
  mysqli_set_charset($dbh, 'utf8');
...
function updateInscripcion($idinsc, $opcion, $idhorario)
{
  ...
  $result = "";
  if (mysqli_query($dbh, $sql)) {
    header('Location: ../academia/?i=success');
    die();
    $result = 1;
  } else {
    header('Location: ../academia/?i=fail');
    die();
    $result = 0;
  }
  return $result;
