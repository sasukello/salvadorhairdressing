    ...
    switch($ubica){
        ...
        <div id="navbar-scroll" class="collapse navbar-collapse navbar-backyard navbar-right">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="pe-7s-user pe-5x pe-va wow fadeInUp"></i> <?php echo $usuario; ?> <span class="caret"></span></a>
