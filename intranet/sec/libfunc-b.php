    ...
    switch($nombre){
       ...
       <?php break;
        ...
        <div class="col-sm-6 feat-list">
            ...
            <div class="inner">
                <a href="http://www.salvadorstore.com/store/admin123" target="_blank"><h4>Salvador Store</h4></a>
    ...
    switch($ubicacion){
        ...
        <div id="navbar-scroll" class="collapse navbar-collapse navbar-backyard navbar-right">
            <ul class="nav navbar-nav">
                ...
                <li><a href="/intranet/"><i class="pe-7s-global pe-5x pe-va wow fadeInUp"></i> Intranet</a></li>
                <li><a href="/intranet/live/ayuda.php"><i class="pe-7s-help1 pe-5x pe-va wow fadeInUp"></i> Ayuda</a></li>
...
function menu3($nombre){
    switch($nombre){
        case 'Accesoremoto1':?>
            ...
            <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="pe-7s-note pe-5x pe-va wow fadeInUp"></i> Apps <span class="caret"></span></a>
                <ul class="dropdown-menu">
                  <li><a href='/intranet/apps'>Principal</a></li>
                  <li class="divider"></li>
                  <li><a href='/intranet/apps'>ClientCard</a></li>
                  <li><a href='/intranet/apps'>Salvador App</a></li>
                </ul>
            </li> 
        <?php break;
        case 'Descargas1':?>
        ...
        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="pe-7s-cloud-download pe-5x pe-va wow fadeInUp"></i> Descargas <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li><a href='/intranet/descargas/cuenta'>Descargar Contenidos</a></li>
              <li><a href='/intranet/descargas/admin'>Actualizar Contenidos</a></li>
            </ul>
        </li>    
        <?php break;
        case 'MysteryShopper1':?>
        ...
        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="pe-7s-users pe-5x pe-va wow fadeInUp"></i> Mystery Shopper <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li><a href='/mysteryshopper'>Sección de Administrador</a></li>
       ...
       <?php break;
        case 'Salvadorstore1':?>
        <li><a href="http://www.salvadorstore.com/store/admin123"><i class="pe-7s-cart pe-5x pe-va wow fadeInUp"></i> Salvador Store</a></li>
        <?php break;
        case 'Minutas1':?>
        <li><a href="/intranet/minutas"><i class="pe-7s-note pe-5x pe-va wow fadeInUp"></i> Minutas</a></li>
        <?php break;
    }
}
   ...
   */
   ...
   if ($rutabd == ""){
    ...
    if ($error == ""){        
        ...
        return "<b>Hubo un error al conectar con el salón:</b>" . $error . " Ruta= " .$rutabd;
    }
}
