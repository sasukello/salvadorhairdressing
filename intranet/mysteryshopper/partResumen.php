...
<html>
    <head>
        <title>Mystery Shopper: Consulta de Participante (Intranet) - Salvador Hairdressing</title>
    ...
    <?php
        if(isset($visita)){
        // RESUMEN DE VISITA
        include '../../mysteryshopper/etc/func.php';?>
            ...
            <nav class="navbar-wrapper navbar-default" role="navigation">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand site-name" href="#top"><img src="/images/60-años-min-wh.jpg" alt="logo"></a>
                    </div>
                </div>
            </nav>
        </div>
