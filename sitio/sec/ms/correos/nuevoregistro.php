    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          ...
          <tr>
            <td class="free-text">
              Un nuevo usuario ha solicitado participar como <b>Mystery Shopper</b> para <b><i>Salvador Hairdressing</i></b>.<br><br>
            </td>
          </tr>
          <div class='table2-responsive' style='overflow-x:auto;'>
                    <table class='table2 table-hover table-condensed'>
                    <thead>
                    <tr>
                    <th colspan="2">Detalles del Participante:</th>
                    </tr>
                    </thead>
                    <tbody>