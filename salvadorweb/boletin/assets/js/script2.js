...
$('#boletin2').on('show.bs.modal', function (event) {     
    ...
    //modal.find('.modal-body input').val(recipient+";"+recipientu);
    //document.getElementById('pnombre').innerHTML = atob(valor2);
    document.getElementById("p2-desc").innerHTML = '<iframe style="width:100%; height:500px;" src="//e.issuu.com/embed.html#30851590/57978280" frameborder="0" allowfullscreen></iframe>';
});
