<?php  include("header.html");
  ...
  if($_POST){
	...
	if(!validmail($email)) {$error.=" - Debe ingresar un correo v&aacute;lido <br/>"; }
	...
	if ($error==""){
		...
		//$para="eirausquin@avacom.com.ve";
		$de="Info";
		$dominio="WWW.SALVADORHAIRDRESSING.COM";
		$asunto="Nueva solicitud de equipo administrativo";
		...
		$cuerpo="Ha recibido una solicitud de incorporaci&oacute;n como empleado<br/><br/><br/><br/>
		Los datos aportados son los siguientes:<br/><br/>
		Nombre: ".encode($nombre)."<br/>
		Apellido: ".encode($apellido)."<br/>
		Tel&eacute;fono: ".encode($telefono)."<br/>
		Sexo: ".encode($sexo)."<br/>
		Email: ".encode($email)."<br/>
		&Aacute;rea de inter&eacute;s: ".encode($area)."<br/>
		Experiencia laboral: ".encode($experiencia)."<br/><br/>";
			 $cuerpo.="<strong>Ip:</strong> $ip<br/>";;
			if ($para<>"" and $de<>"" and $dominio<>"" and $asunto<>"" and $cuerpo<>"") {
				mail($para,$asunto,$cuerpo,$from_header);
				$rs=iweb_guardar_data("iweb_administrativo","nombre,apellido,telefono,sexo,email,experincia,estado,ipaddress","'$nombre','$apellido','$telefono','$sexo','$email','$experiencia','0','$ip'");
					$dominio="";
					$nombre="";
					$apellido="";
					$telefono="";
...
<div id="AVA_CONTENEDOR_PRINCIPAL">
		<div id="home_cont_keep_out"  class="border-header-center" style=" clear:both;width:997px; min-height:540px; height:auto; overflow:auto; margin: 0 auto; background-color:#fff;padding-bottom:10px;">
			<div id="grey_box" style="width:877px;height:181px;margin:auto;"><img src="images/equipo.jpg" width="877" height="181" /></div>
