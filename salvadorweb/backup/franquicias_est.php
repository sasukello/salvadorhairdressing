<?php  include("header.html");
 include("iweb/sitio/funciones.php");
  if($_POST){
	...
	$medio=$_POST['medio'];
	$busqueda=limpia($_POST['busqueda']);
	...
	if($salvador=="") {$error.=" - Debe seleccionar alguna franquicia<br/>"; $errorn="1";}
     ...
     $cuerpo.='<b>Estudio de mercado:</b> '.encode($mercado).'<br/>';
     $cuerpo.='<b>b&uacute;squeda de locales o compra de salones existentes:</b> '.encode($busqueda).'<br/>';	
     $cuerpo.='<b>Com&oacute; supo de nosotros:</b> '.encode($medio).'<br/>
	  <b>Tipo de franquicia:</b> '.encode($salvador).'<br/>';
	 $cuerpo.="<strong>Ip:</strong> $ip<br/>";
	if ($error==""){
	    $para="INFO@SALVADOR.COM.VE , ADMINISTRACION@SALVADOR.COM.VE , FRANQUICIAS@SALVADOR.COM.VE";
		//$para="franquicias@salvador.com.ve,administracion@salvador.com.ve";
		$de="Info";
		$dominio="www.salvador.com.ve";
		$asunto="Nueva franquicia estilista";
	    ...
	    $rs=iweb_guardar_data("franquicia_est","fecha,nombre,ciudad,estado,correo,telf,movil,educacion,fechan,tiempo,conyuge,otro,ubicacion,tamano,medio,salvador,mercado,busqueda,ipaddress","now(),'$nombre','$ciudad','$estado','$email','$telefono','$movil','$nivel','$fecha','$nnegocio','$conyuge','$otra','$ubicacionc','$ubicacion','$medio','$salvador','$mercado','$busqueda','$ip'");
		$dominio="";
		$nombre="";
		$ciudad="";
		$estado="";
...
<div style="width:877px; min-height:750px; height:auto; margin:auto">
		...
		<div id="texto" style="text-align:justify;margin-bottom:20px">Nuestra
			 raz&oacute;n de existir es el cliente.  La atenci&oacute;n personalizada, entusiasta y
			 amable es nuestro sello, ofrecer los mejores servicios y productos 
			profesionales nuestro compromiso.<br /><br />

			Gracias a su extensa trayectoria y calidad de servicios Grupo 
			salvador se ha convertido en sin&oacute;nimo de excelencia y ha desarrollado de
			 esta manera una enorme ventaja competitiva que permite a nuestra 
			organizaci&oacute;n tomar las riendas del fabuloso proyecto de expansi&oacute;n y 
			posicionamiento: Franquicias Salvador.<br /><br />
			Franquicias Salvador es la herramienta que le permitir&aacute; como 
			empresario formar parte de la red m&aacute;s completa de Salones de Belleza de 
			Venezuela.  Su amplio portafolio de opciones de belleza integral para 
			toda la familia, representa la inversi&oacute;n m&aacute;s atractiva del mercado en el
			 &aacute;rea de Belleza y Salud. <br /><br />
			Grupo Salvador organizaci&oacute;n innovadora y din&aacute;mica, garantiza a sus 
			franquiciados la asesor&iacute;a, capacitaci&oacute;n, supervisi&oacute;n comercial, t&eacute;cnica y
			 empresarial necesarias para la &oacute;ptima administraci&oacute;n de sus unidades de
			 negocio. Como muestra de valor agregado nuestras franquicias cuentan 
			adem&aacute;s con el respaldo de la exclusiva alianza L`OREAL y KERASTASE, 
			profesionales de alto prestigio internacional.  Franquicias Salvador 
			representa un exclusivo compendio de beneficios que acreditaran a su 
			inversi&oacute;n los elementos precisos para la excelencia.
		</div>
...
<div style="width:430px; height:auto;float:left">
        <div id="title2" style="height:18px;background-color:#fc0606;color:#FFF;padding:3px 0 0 3px;font-weight:bold">OBJETIVOS Y METAS GERENCIALES</div><table width="430" border="0" cellspacing="0" cellpadding="3">
  <tr style="height:30px">
