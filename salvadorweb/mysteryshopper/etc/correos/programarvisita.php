    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td class="header-lg">
              ¡Datos Bancarios Completados!
            </td>
          </tr>
          <tr>
            <td class="free-text">
              El usuario ha indicado satisfactoriamente sus datos bancarios. Por lo cual ya es elegible para tener visitas como <b>Mystery Shopper</b>. Inicia sesión con tu cuenta corporativa, para <b>programarle una visita</b>:
            </td>
          </tr>
          <tr>
            <td class="button">
