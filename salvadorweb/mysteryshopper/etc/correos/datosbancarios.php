    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td class="header-lg">
              ¡Estás cerca de ser un Mystery Shopper!
            </td>
          </tr>
          <tr>
            <td class="free-text">
              Para empezar a recibir notificaciones de visitas programadas como <b>Mystery Shopper</b> de <b><i>Salvador Hairdressing</i></b>, es necesario que <b>completes tus datos bancarios</b>. Ingresa ahora tu cuenta:
            </td>
          </tr>
          <tr>
            <td class="button">
              <div><!--[if mso]>
                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://www.salvadorhairdressing.com/mysteryshopper" style="height:45px;v-text-anchor:middle;width:155px;" arcsize="15%" strokecolor="#ffffff" fillcolor="#ff6f6f">
                  <w:anchorlock/>
                  <center style="color:#ffffff;font-family:Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;">Completar mis Datos</center>
                </v:roundrect>
              <![endif]--><a class="button-mobile" href="http://www.salvadorhairdressing.com/mysteryshopper"
              style="background-color:#ff6f6f;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">Completar Mis Datos</a></div>
            </td>
          </tr>
        </table>
      </center>
                                ...
                                <table cellspacing="0" cellpadding="0" width="100%">
                                  <tr>
                                    <td style="text-align:left; width:155px">
                                      <a href=""><span class="header-sm">Rellenar tus datos bancarios</span></a><br />
                                      Recuerda, que para ralizar visitas como <b>Mystery Shopper</b> a nuestros salones de belleza, <b>debes completar la encuesta</b> donde nos informas de tus datos bancarios.
                                    </td>
