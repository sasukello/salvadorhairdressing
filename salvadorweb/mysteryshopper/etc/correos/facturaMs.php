    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td class="header-lg">
              !Nueva factura de Mystery Shopper!
            </td>
          </tr>
          <tr>
            <td class="free-text">
              <strong>El participante ha enviado su factura de pago.</strong>
          ...
          <tr>
            <td class="button">
              <div>
                <a class="button-mobile" href="http://www.salvadorhairdressing.com/intranet/mysteryshopper"
                style="background-color:#ff6f6f;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width: 225px;-webkit-text-size-adjust:none;mso-hide:all;">Inicia sesión</a>
            </div>
            </td>
          </tr>
        </table>
