    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td class="header-lg">
              ¡Nueva Solicitud de Mystery Shopper!
            </td>
          </tr>
          <tr>
            <td class="free-text">
              Un nuevo usuario ha solicitado participar como <b>Mystery Shopper</b> de <b><i>Salvador Hairdressing</i></b>. Inicia sesión con tu cuenta corporativa en el portal web, para <b>aprobar o rechazar</b> la solicitud:
            </td>
          </tr>
          <tr>
            <td class="button">
              ...
              style="background-color:#ff6f6f;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width: 225px;-webkit-text-size-adjust:none;mso-hide:all;">Revisar Solicitud</a></div>
            </td>
          </tr>
        </table>
      </center>
