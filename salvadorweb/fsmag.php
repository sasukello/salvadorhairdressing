  ...
  <div class="dark-wrapper">    
    <div class="container inner2 nopadding-bottom">
      <div class="blog row">
        ...
        <div class="col-md-7">
          <div class="item post">
              <figure class="main sinmargen" style="height: 450px;"><iframe style="width:100%; height:450px;" src="//e.issuu.com/embed.html#30851590/68009322" frameborder="0" allowfullscreen></iframe></figure>
              <div class="box text-center">
                <div class="category cat16"><span class="sinpadding"><a href="//fsinter.com/ediciones/actual.php" target="_blank"><?php echo _('Edición 38'); ?></a></span></div>
                <p><div class="meta"><?php echo _('Revista fs magazine. Edición 38.'); ?></div></p>
              </div>
          </div>
        </div>
